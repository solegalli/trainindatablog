...
author: sole
description: "Discover different methods for feature selection for machine learning, what their advantages and limitations are, and why it matters."
excerpt: "Discover different methods for feature selection for machine learning, what their advantages and limitations are, and why it matters."
categories: [Feature Selection, Machine Learning]
image: assets/images/posts/feature-selection-for-machine-learning/cover.png
---
...
![Animation showing the process of feature selection]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/FS-arrow-gif.gif)
...
![Animation showing the process of variable examination]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/data-analysis.gif)
...
Generally, these methods have characteristics that allow them to group into one of three categories: [filter methods](https://www.blog.trainindata.com/feature-selection-with-filter-methods/), [wrapper methods](https://www.blog.trainindata.com/feature-selection-with-wrapper-methods/), and [embedded methods](https://www.blog.trainindata.com/feature-selection-with-embedded-methods/).
...
![Animation showing the distribution of a constant feature]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/paper-function-gif.gif)

Although it sounds obvious and overly simple, many datasets contain a lot of constant, quasi-constant, and duplicated features. In fact, duplicated features often arise when generating new features by [one-hot encoding](https://www.blog.trainindata.com/one-hot-encoding-categorical-variables/) of categorical variables. Removing these features is an easy but effective way to reduce the dimension of the feature space, without losing any significant information.
...
![Diagrams showing two correlated variables.]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/linear-regression.png)
...
![Diagram showing the process of feature selection by ranking features]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/rank-features.png)
...
**[Mutual information](https://www.blog.trainindata.com/mutual-information-with-python/)** measures the mutual dependence between two variables, in this case, the feature and the target. Mutual information is similar to correlation, but more general; it doesn’t strictly represent linear association. It measures how much knowing one of these variables reduces uncertainty in the other.
...
![Contingency tables showing the absolute numbers and proportions of survivors in the titanic segregated by gender.]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/contingency-table.png)
...
![Diagram showing the process of feature selection with wrapper methods]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/FS_4.png)
...
![Diagram showing the process of forward selection of features.]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/FS_5.png)
...
![Diagram showing the process of backward elimination of features.]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/FS_6.png)
...
[Lasso](https://www.blog.trainindata.com/lasso-feature-selection-with-python/) can shrink some coefficients of the linear regression to zero. This indicates that the predictor can essentially be multiplied by zero to estimate the target and consequently doesn’t add to the overall prediction of the output.
...
![Diagram of a decision tree]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/FS_9.png)
...
[Recursive feature elimination](https://www.blog.trainindata.com/recursive-feature-elimination-with-python/) (RFE) consists of the following steps:

![Diagram showing the process of recursive feature elimination]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/FS_10.png)
...
![Diagram showing the process of recursive feature addition.]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/FS_11-1024x256.png)
...
![Animation showing the process of permutation feature importance]({{ site.baseurl }}/assets/images/posts/feature-selection-for-machine-learning/FeatureShufflingGIf.gif)
...
- [Feature Selection in Machine Learning with Python](https://www.trainindata.com/p/feature-selection-in-machine-learning-book) — Book
