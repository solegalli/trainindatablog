...
image: assets/images/posts/learn-ai-from-scratch/learn-ai-from-scratch.gif
---
...
![Skills needed for ai]({{ site.baseurl }}/assets/images/posts/data-science-prerequisites/skills-for-ai.png)
...
If you like learning from courses, check our our recommendations on [data science and machine learning courses](https://www.blog.trainindata.com/data-science-and-machine-learning-courses/). If you prefer reading, we also have you covered; check out our recommendations for best [machine learning books for beginners](https://www.blog.trainindata.com/machine-learning-books-for-beginners/).
...
The first step is to learn the most basic skills. You can do this with books, AI courses, or blogs. There are numerous tutorials and artificial intelligence courses available on sites like Coursera, Udemy, and [Train in Data](https://www.trainindata.com/courses/). If you are looking for open-source online courses, there are free videos available of MIT OCW on YouTube. I am adding a few basic courses to help you get started:

- [Python for Everybody Specialization” by the University of Michigan on Coursera](https://www.py4e.com/)
- [Stanford’s CS229: Machine Learning” by Stanford University](https://youtube.com/playlist?list=PLoROMvodv4rMiGQp3WXShtMGgzqpfVfbU&si=A8GVoFQcINlYgE2A)
- [Introduction to Data Science in Python](https://www.datacamp.com/courses-all)
- [“Deep Learning Specialization” by deeplearning.ai](https://www.deeplearning.ai/short-courses/)
