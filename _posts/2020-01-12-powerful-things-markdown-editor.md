...
![]({{ site.baseurl }}/assets/images/posts/mi_eq1.png)
...
![walking]({{ site.baseurl }}/assets/images/posts/ch4-eq5.png)
...
[]({{ site.baseurl }}/assets/images/posts/ch-mi-knn.png)
...
3- We count the total number of observations (m~i~), red and otherwise, within d of the observation in question.
...
![walking]({{ site.baseurl }}/assets/images/posts/ch4-eq6.png)

where \psi$ is the digamma function. To estimate the MI from the data set, we average I_i$ over all data points:

![walking]({{ site.baseurl }}/assets/images/posts/ch4-eq7.png)

To evaluate the association between 2 continuous variables the MI is calculated as:

![walking]({{ site.baseurl }}/assets/images/posts/ch4-eq8.png)
