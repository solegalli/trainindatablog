...
$$H(X) = -(0.5 \times log(0.5) + 0.5 \times log(0.5))$$
...
{widht= 80%}!
[Nearest-neighbor approach to estimate the MI. Taken from Ross, 2014, PLoS ONE 9(2): e87357.]({{ site.baseurl }}/assets/images/posts/ch-mi-knn.png)
