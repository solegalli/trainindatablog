...
image: assets/images/posts/data-discretization-in-machine-learning/cover-1.gif
---
...
![]({{ site.baseurl }}/assets/images/posts/data-discretization-in-machine-learning/ChallengeDiscretization.gif)
...
![Diagram showing the pros and cons of data discretization]({{ site.baseurl }}/assets/images/posts/data-discretization-in-machine-learning/discretization-tradeoff.png)
...
![Diagram showing 4 methods of data discretization: equal-width, equal frequency, using K-means and using decision trees.]({{ site.baseurl }}/assets/images/posts/data-discretization-in-machine-learning/DiscretizationMethods.gif)
...
We can also implement equal-frequency discretization with [Feature-engine](https://feature-engine.trainindata.com/en/latest/api_doc/discretisation/EqualFrequencyDiscretiser.html).
...
For video tutorials on discretization, check our course [Feature Engineering for Machine Learning](https://www.trainindata.com/p/feature-engineering-for-machine-learning).
